...
<!-- content -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>订单商品格式</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['num']; ?></p></div>
          </div>
          <div class="container-fluid">
          ...
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['paydate']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>支付时间</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['paytime']; ?></p></div>
          </div>
