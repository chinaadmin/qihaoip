...
<body>
  ...
  <div class="thrwid moban_dianzhao" style="background:url(<?php echo $data['ad']['6']['state']==3&&$data['ad']['6']?$data['ad']['6']['img']:STATIC_V2."images/blue6.jpg" ?>) top center no-repeat;">
    <div class="thrfloor1 moban_logo">
      <div class="shop_logo shop_logos"> <a href="<?php echo U('Index/shop/shop_list',array('id'=>$data['shop_re']['id']))?>"><img src="<?php echo $data['shop_re']['logo']?$data['shop_re']['logo']:STATIC_V2.'images/logo_default.jpg'?>"/></a> </div>
      <div class="moban_title"> <?php echo $data['shop_re']['name']?>旗舰店</div>
    </div>
  </div>
  <!--logo与导航-->
  <!--头部-->
  ...
  <div class="thrwid moban_banner">
    <div class="thrfloor1 moban_banners">
      <div class="flexslider">
        ...
        <?php endforeach;?>
         <?php else:?>
       	     <li style="background:url(<?php echo STATIC_V2.'images/blue1.jpg'?>) 50% 0 no-repeat;"><a href="<?php echo $value['link']?>" target="_blank"><img src="<?php echo STATIC_V2;?>images/blank.png" width="100%" height="430"></a></li>
         <?php endif?>
        </ul>
      </div>
    </div>
  ...
  <div class="thrfloor1">
    <div class="col-xs-12 thrsbscst">
      <div class="col-xs-12 shopsb_tit"><img src="<?php echo STATIC_V2;?>images/moban_f1.png"/><b>商标</b><span><a href="<?php create_url('shop',array('shop'=>$data['shop_id']))?>" target="_blank">更多>> </a></span></div>
            ...
            <ul class="51buypic">
             ...
             <?php else:?>
	        	...
	        	<?php if(count($data['ad']['2'])==$i||!$data['ad']['2']):?>
	        		 <li><a  target="_blank"><img src="<?php echo STATIC_V2.'images/blue2.jpg'?>" /></a></li>
	        	<?php endif;?>
	        <?php endif?>
       	     <?php endforeach;?>
       	      <?php else:?>
      ...
      <div class="col-xs-12 thrguangao"> <img src="<?php echo $data['ad']['3']['state']==3&&$data['ad']['3']?$data['ad']['3']['img']:STATIC_V2.'images/blue3.jpg'?>"/> </div>
    </div>
  </div>
  <!--商标-->
  <?php endif;?>
  ...
  <div class="thrfloor1">
    <div class="col-xs-12 thrsbscst">
      <div class="col-xs-12 shopsb_tit"><img src="<?php echo STATIC_V2;?>images/moban_f2.png"/><b>专利</b><span><a href="<?php echo U('shop/patnetlist',array('shop'=>$data['shop_id']))?>" target="_blank">更多>> </a></span></div>
      <div class="col-xs-12 shopsb_con">
        <div class="col-xs-3 shopsb_img moban_img">
             ...
             <li><a href="<?php echo $value['link']?>" target="_blank"><img src="<?php echo $value['img']?>" /></a></li>
              <?php else:?>
	        	...
	        	<?php if(count($data['ad']['4'])==$i||!$data['ad']['4']):?>
	        		 <li><a  target="_blank"><img src="<?php echo STATIC_V2.'images/blue4.jpg'?>" /></a></li>
	        	<?php endif;?>
	        <?php endif?>
       	     <?php endforeach;?>
       	      <?php else:?>
      ...
      <div class="col-xs-12 thrguangao"> <img src="<?php echo $data['ad']['5']['state']==3&&$data['ad']['5']?$data['ad']['5']['img']:STATIC_V2.'images/blue5.jpg'?>"/> </div>
    </div>
  </div>
  <!--专利-->
   <?php endif;?>
