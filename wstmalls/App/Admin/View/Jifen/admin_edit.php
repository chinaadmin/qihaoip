...
<!-- content -->
        ...
        <?php } ?>        
          <ol class="breadcrumb">
  			...
  			<li class="active">积分设置编辑</a></li>
		  </ol>
          <h4 class="sub-header">编辑积分设置-用于设置用户行为积分值</h4>
          <div class="container-fluid">
<form class="form-horizontal" id="form-edit" action="#" method="post" onsubmit="return toVaild('form-edit')">
  ...
  <div class="form-group">
    <label for="Admin-Jifen-about" class="col-sm-2 col-md-1 col-lg-1  control-label">积分描述</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
