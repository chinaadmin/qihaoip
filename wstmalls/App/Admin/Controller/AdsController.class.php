...
class AdsController extends AdminBaseController {
	...
	public function admin_add(){
		...
		if(IS_POST){
			...
			$value['name'] = $this->I_chk('post.name','广告位置',0,0);
			$value['high'] = $this->I_chk('post.high','宽度',0,0);
			$value['width'] = $this->I_chk('post.width','高度',0,0);
			$value['about'] = $this->I_chk('post.about','备注信息',0,0);
