...
<!-- content -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <ol class="breadcrumb">
  			...
  			<li class="active">站内广告查看数据</li>
		  </ol>
          <h4 class="sub-header">数据详情站内广告-包含banner、站内图片广告、滚动广告等</h4>
          <div class="container-fluid">
          <div class="container-fluid">
          ...
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>广告详情</strong></div>
          ...
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>nofollow属性</strong></div>
