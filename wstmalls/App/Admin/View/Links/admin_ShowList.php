...
<!-- content -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <ol class="breadcrumb">
  			...
  			<li><span>友情链接组管理</span></li>
  			<li class="active">友情链接组列表&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo U('admin_add'); ?>" target="_blank">新增友情链接组</a></li>
		  </ol>
          <div class="panel panel-default">
		  <div class="panel-heading">
<form class="form-inline" action="<?php echo U('admin_ShowList'); ?>" id="form-search" method="post">
  <div class="form-group">
    <label for="Admin-Links-id">ID</label>
    <input type="text" class="form-control input-sm" name="id" id="Admin-Links-id" <?php if(isset($search['id'])){echo 'value="'.$search['id'].'"'; } else {echo 'placeholder="数据id"'; } ?>>
  </div>
  <div class="form-group">
    <label for="Admin-Links-name">分类名称</label>
    <input type="text" class="form-control input-sm" name="name" id="Admin-Links-name" <?php if(isset($search['name'])){echo 'value="'.$search['name'].'"'; } else {echo 'placeholder="数据详情"'; } ?>>
  </div>
  <div class="form-group">
    <label for="Admin-Links-img">链接图片</label>
    <input type="text" class="form-control input-sm" name="img" id="Admin-Links-img" <?php if(isset($search['img'])){echo 'value="'.$search['img'].'"'; } else {echo 'placeholder="数据详情"'; } ?>>
  </div>
