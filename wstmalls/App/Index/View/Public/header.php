...
<html lang="zh-cn">
<head>
<title><?php echo $data['title']?$data['title']:$data['siteInfo']['web_title']; ?><?php echo $data['isindex'] == TRUE?'':'-7号网'?></title>
  ...
  <div class="kuang vtop">
    ...
    <div class="col-xs-6 yanse vrights">
      <ul>
	            ...
	            <volist name="data['cart']['data']" id="vo">
	              <li>
	                ...
	                <else/>
	                  ...
	                  <p>{$vo['title']}</p>
	                  <p><span>{$vo['price']}</span>元&nbsp;|&nbsp;<a href="javascript:;" onclick="del_cart({$vo['id']})">删除</a></p>
	                </div>
	              </li>
	            </volist>  
	            </ul>
        ...
        <li>
        	<a href="javascript:;"><span>网站导航</span></a>
            <div class="xialas">
	            <ul>
        ...
        <<li><a href="__APP__/help/" rel="nofollow" target="_blank">帮助中心</a></li>
    ...
    <div class="col-xs-8 top_search">
      <div class="top_searchs">
     	<div class="searchs_libie">
          ...
          <elseif condition="(CONTROLLER_NAME eq 'News') OR (CONTROLLER_NAME eq 'Help')" />  
          	<li><a href="javascript:;" class="libie_ons">综合</a></li>
          <else/>
       ...
       <form action="{:U('search/index')}" target="_blank"  method="get">
        ...
        <else/>
          ...
          <if condition="(CONTROLLER_NAME eq 'News') OR (CONTROLLER_NAME eq 'Help')"> 	
        	<input type="name" name="type" class="top_searchst" placeholder="请输入关键词" id="bdcsMain"/>
          <else/>
