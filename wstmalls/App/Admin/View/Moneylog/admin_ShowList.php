...
<!-- content -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <ol class="breadcrumb">
  			...
  			<li><span>资金流水管理</span></li>
  			<li class="active">资金流水列表&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo U('admin_add'); ?>" target="_blank">新增资金流水</a></li>
		  </ol>
          <div class="panel panel-default">
		  <div class="panel-heading">
<form class="form-inline" action="<?php echo U('admin_ShowList'); ?>" id="form-search" method="post">
  <div class="form-group">
    <label for="Admin-Moneylog-id">ID</label>
    <input type="text" class="form-control input-sm" name="id" id="Admin-Moneylog-id" <?php if(isset($search['id'])){echo 'value="'.$search['id'].'"'; } else {echo 'placeholder="数据id"'; } ?>>
  </div>
            ...
            <table class="table table-striped table-condensed">
              ...
              <?php foreach ($data['rows'] as $row){ ?>
                <tr class="active">
                  ...
                  <td><?php echo $row['beginmoney']; ?></td>
                  <td><?php echo $row['endmoney']; ?></td>
