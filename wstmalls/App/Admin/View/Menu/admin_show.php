...
<!-- content -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <ol class="breadcrumb">
  			...
  			<li class="active">导航菜单查看数据</li>
		  </ol>
          <h4 class="sub-header">数据详情导航菜单-页面的导航菜单</h4>
          <div class="container-fluid">
          <div class="container-fluid">
          ...
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>所在类别</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['groupid']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>上级导航</strong></div>
          ...
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>链接地址</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['link']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>链接说明</strong></div>
