			...
			<div class="hytit">
				<div class="paleft">
					您当前的位置：<a href="<?php echo U('Trade/Index/Index')?>">商标管家</a> > <a
						href="<?php echo U('Trade/GjTrade/cost_list')?>">费用管理</a>
				</div>
			</div>
			<div class="hgrzy">
				<!--查询-->
				<div class="col-xs-12 patjb">
					<div class="col-xs-12 ">
						<div class="zlyjjyst">
							...
							<a href="<?php echo U('Trade/GjTrade/fee_del')?>" class="btn btn-default postsh">一键删除</a>
						</div>
						<div class="zlyjjyst1">
							<form method="post" action="<?php echo U('Trade/GjTrade/cost_list')?>">
								<div class="formdivs">
						...
						<?php foreach ($list['trade'] as $key=>$value):?>
							<tr class="zlhover" id="<?php echo $value['uid']?>">
								...
								<td width="15%">
									...
									<a href="<?php echo U('Trade/GjTrade/fee_edit',array('uid'=>$value['uid']))?>"  class="tabaction tabactiont"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
								</td>
							</tr>
							<?php endforeach;?>
							<tr>
								<td colspan="13">
									...
									<div class="seltot">
										...
										<a href="javascript:void(0)" class="btn btn-default adddel" url="<?php echo U('Trade/GjTrade/fee_del')?>">删除</a>
									</div>
								</td>
							</tr>
						</tbody>
...
$(".posts3").live('click',function(){
	...
	var obj = $(this);
	var url = "<?php echo U('Trade/GjTrade/show_cost')?>";
