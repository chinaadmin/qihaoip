    ...
    <div class="thrfloor1 shop_navs_cont">
      ...
      <div class="goods_shop goods_shop_display">
          ...
          <div class="goods_shopt">
            <h2><a href="javascript:;"><span class="glyphicon glyphicon-registration-mark" aria-hidden="true"></span> 商标热门分类</a></h2>
          </div>
      ...
      <ul>
        <volist name="data['menu']" id="vo">
              <li><a href="{$vo['link']}" title="{$vo['title']}" <if condition=" '__SELF__' eq $vo['link']">class="shop_ons"</if>>{$vo['name']}</a></li>
          </volist>
      </ul>
    </div>
  </div>
