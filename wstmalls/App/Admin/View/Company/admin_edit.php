...
<!-- content -->
        ...
        <?php } ?>        
          <ol class="breadcrumb">
  			...
  			<li class="active">公司数据编辑</a></li>
		  </ol>
          <h4 class="sub-header">编辑公司数据-公司注册信息等数据</h4>
          <div class="container-fluid">
...
<?php get_select('PERSON_CHK', $data['state']) ?>
    ...
    <label for="Admin-Company-reason" class="col-sm-2 col-md-1 col-lg-1  control-label">验证原因</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
