...
<!-- content -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <ol class="breadcrumb">
  			...
  			<li><span>导航菜单管理</span></li>
  			<li class="active">导航菜单列表&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo U('admin_add'); ?>" target="_blank">新增导航菜单</a></li>
		  </ol>
          <div class="panel panel-default">
		  <div class="panel-heading">
<form class="form-inline" action="<?php echo U('admin_ShowList'); ?>" id="form-search" method="post">
  <div class="form-group">
    <label for="Admin-Menu-id">ID</label>
    <input type="text" class="form-control input-sm" name="id" id="Admin-Menu-id" <?php if(isset($search['id'])){echo 'value="'.$search['id'].'"'; } else {echo 'placeholder="数据id"'; } ?>>
  </div>
  <div class="form-group">
    <label for="Admin-Menu-groupid">所在类别</label>
    <select class="form-control" id="Admin-Menu-groupid" name="groupid">
    <option value ="0">未选择</option>
<?php get_select('menus', $search['groupid']) ?>
	</select>
  </div>  <div class="form-group">
    <label for="Admin-Menu-state">是否显示</label>
