				...
				<!--商标状态-->
                  ...
                  <div class="col-xs-12 allwidth <?php echo $list['uid'].$list['rel']?>">
                    <div class="col-xs-12 fbtjtith">
                      ...
                      <p class="zlblacks"><a href="<?php echo U('Trade/GnTrade/cost_list')?>"  data-toggle="tooltip" data-placement="right" title="点击查看费用清单"><img src="<?php echo STATIC_V2;?>images/zlfei.png"/></a></p>
                    </div>
                    <div class="col-xs-12 fbtjlist">
			      ...
			      <div id="gg2" class="patupianss patupiansst">
			        ...
			        <form method="post" class="form-horizontal" action="" id='feeforms' uid="<?php echo $list['uid']?>">
					  ...
					  <div class="sb_feiyou_img"><span><b>商标图样：</b></span><img src="<?php $img = explode(',',$list['trade_data']['img']); echo $img[0]?$img[0]:U('tmimg',array('id'=>$list['trade_data']['reg_id'],'class'=>C('TYPE_CODE')[$list['trade_data']['trade_class_id']])); ?>"></div>
					  <div class="sb_feiyou_wenzi">
					  <p>注册号：<?php echo strlen($list['trade_data']['trade_id'])>15?ttmid($list['trade_data']['trade_id']):$list['trade_data']['trade_id']?></p>
