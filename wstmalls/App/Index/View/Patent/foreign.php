...
<div class="thrwid guowai_banner">
</div>
  <!--专利-->
  <div class="thrfloor1">
    <div class="col-xs-12 guowai_select guowai_2016_03_18">
  <div class="col-xs-12 ">
            <div class="col-xs-12 zlsellist_guowai zls1 noborder_guowai" id="selects">
              <p class="guowai_teshu">国外专利 ></p>
              <ul>
			  ...
			  <p class="ybs"><a href="__APP__/patent/foreign/listHTMLSUFFIX" class="btn btn-default btn-xs delall">全部撤销</a></p>
            </div>
		  ...
		  <div class="col-xs-12 zlsellist_guowai noborder_guowai">
            ...
            <if condition="count($data['shop']) gt '14'">
			  <p class="ybs"><a href="javascript:" title="#" class="btn btn-default btn-xs more" rel="1">更多</a></p>
            </if>
            </div>
        </div>
    </div>
  ...
  <notempty name="data['goods']">
   ...
   <notempty name="data['page']">
    <div class="col-xs-12 daohan_background">
		{$data['page']}
    </div>
   </notempty>
 <else/>
...
function patent_url(id,type){
	...
	if(url){
		patenturl = "__APP__/patent/foreign/listHTMLSUFFIX?";
	}else{
		patenturl = "__APP__/patent/foreign/listHTMLSUFFIX";
	}		
