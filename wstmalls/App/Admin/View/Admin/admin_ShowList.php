...
<!-- content -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <ol class="breadcrumb">
  			...
  			<li><span>管理组管理</span></li>
  			<li class="active">管理组列表&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo U('admin_add'); ?>" target="_blank">新增管理组</a></li>
		  </ol>
          <div class="panel panel-default">
		  <div class="panel-heading">
<form class="form-inline" action="<?php echo U('admin_ShowList'); ?>" id="form-search" method="post">
  <div class="form-group">
    <label for="Admin-Admin-id">ID</label>
    <input type="text" class="form-control input-sm" name="id" id="Admin-Admin-id" <?php if(isset($search['id'])){echo 'value="'.$search['id'].'"'; } else {echo 'placeholder="数据id"'; } ?>>
  </div>
  <div class="form-group">
    <label for="Admin-Admin-name">管理组名称</label>
    <input type="text" class="form-control input-sm" name="name" id="Admin-Admin-name" <?php if(isset($search['name'])){echo 'value="'.$search['name'].'"'; } else {echo 'placeholder="中文名称"'; } ?>>
  </div>
  <div class="form-group">
    <label for="Admin-Admin-state">状态</label>
