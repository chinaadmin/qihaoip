...
<!-- content -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <ol class="breadcrumb">
  			...
  			<li><span>文章分类管理</span></li>
  			<li class="active">文章分类列表&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo U('admin_add'); ?>" target="_blank">新增文章分类</a></li>
		  </ol>
          <div class="panel panel-default">
		  <div class="panel-heading">
<form class="form-inline" action="<?php echo U('admin_ShowList'); ?>" id="form-search" method="post">
  <div class="form-group">
    <label for="Admin-Articles-id">ID</label>
    <input type="text" class="form-control input-sm" name="id" id="Admin-Articles-id" <?php if(isset($search['id'])){echo 'value="'.$search['id'].'"'; } else {echo 'placeholder="数据id"'; } ?>>
  </div>
  <div class="form-group">
    <label for="Admin-Articles-upid">上级分类</label>
    <select class="form-control" id="Admin-Articles-upid" name="upid">
    	<option value ="0">未选择</option>
		<?php get_select('articles', $search['upid'], 'upid=0') ?>
	</select>
  </div>
            ...
            <table class="table table-striped table-condensed">
              ...
              <?php foreach ($data['rows'] as $row){ ?>
                <tr class="active">
                  ...
                  <td><?php echo $row['indexstyle']; ?></td>
                  <td><?php echo $row['liststyle']; ?></td>
