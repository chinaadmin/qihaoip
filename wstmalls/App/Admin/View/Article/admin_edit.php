<include file="Public/header_nav"/>
  			...
  			<li class="active">文章管理编辑</a></li>
		  </ol>
          <h4 class="sub-header">编辑文章管理-文章包含新闻资讯帮助等各种图文数据</h4>
          <div class="container-fluid">
<form class="form-horizontal" id="form-edit" action="#" method="post" onsubmit="return toVaild('form-edit')">
  <div class="form-group">
    <label for="Admin-Article-groupid"  class="col-sm-2 col-md-1 col-lg-1  control-label">分类</label>
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="Admin-Article-groupid2" name="groupid2" onchange="select('Admin-Article-groupid2','Admin-Article-groupid3');">
    	<option value ="0">未选择</option>
    	<?php get_select('articles', $data['groupid2'],'level=2 and upid='.$data['groupid']) ?>
	</select>
	</div>
  </div>
  <div class="form-group">
    ...
    <select class="form-control" id="Admin-Article-groupid3" name="groupid3">
    	...
    	<?php 
    		if($data['groupid2']){
    			get_select('articles', $data['groupid3'],'level=3 and upid='.$data['groupid2']);
    		}
    	?>
	</select>
	</div>
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="Admin-Region-pid" name="proid" onchange="select1('Admin-Region-pid','Admin-Region-cid');">
    	<option value ="0">未选择</option>
		<?php get_select('region',$data['province'],'level=1','','id','areaname') ?>
	</select>
	</div>
    ...
    <select class="form-control" id="Admin-Region-cid" name="cityid" onchange="select1('Admin-Region-cid','select_2');" >
		<option value ="0">未选择</option>
		<?php get_select('region',$data['city'],'level=2','','id','areaname') ?>
	</select>
	</div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="Admin-Article-description" class="col-sm-2 col-md-1 col-lg-1  control-label">描述</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
...
<?php get_select('ARTICLE_TYPE', $data['hot1']) ?>
   ...
   <div class="form-group">
    <label for="Admin-Article-state"  class="col-sm-2 col-md-1 col-lg-1  control-label">推荐</label>
    <div class="col-sm-3 col-md-2 col-lg-2">
    <select class="form-control" id="Admin-Article-state" name="tmpa">
    <option value ="0">未选择</option>
	 <?php get_select('BAIKE_TYPE', $data['tmpa']) ?>
	</select>
	</div>
  </div>
  <div class="form-group">
