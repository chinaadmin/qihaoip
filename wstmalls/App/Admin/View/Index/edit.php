...
<form class="form-horizontal" id="form-edit">
  <div class="form-group">
    ...
    <input type="email" class="form-control" placeholder="必填：请输入邮箱" id="exampleInputEmail1" placeholder="Email" required>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10 col-md-11 col-lg-11">
    <div class="btn btn-default" onclick="add('form-edit')">Submit</div>
    </div>
  </div>
</form>
          </div> 
