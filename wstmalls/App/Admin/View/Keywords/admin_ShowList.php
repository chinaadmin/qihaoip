...
<!-- content -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <ol class="breadcrumb">
  			...
  			<li><span>热门搜索词管理</span></li>
  			<li class="active">热门搜索词列表&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo U('admin_add'); ?>" target="_blank">新增热门搜索词</a></li>
		  </ol>
          <div class="panel panel-default">
		  <div class="panel-heading">
<form class="form-inline" action="<?php echo U('admin_ShowList'); ?>" id="form-search" method="post">
  <div class="form-group">
    <label for="Admin-Keywords-id">ID</label>
    <input type="text" class="form-control input-sm" name="id" id="Admin-Keywords-id" <?php if(isset($search['id'])){echo 'value="'.$search['id'].'"'; } else {echo 'placeholder="数据id"'; } ?>>
  </div>
  <div class="form-group">
    <label for="Admin-Keywords-groupid">关键词组</label>
    <select class="form-control" id="Admin-Keywords-groupid" name="groupid">
    <option value ="0">未选择</option>
<?php get_select('keywords', $search['groupid']) ?>
	</select>
  </div>  <div class="form-group">
    <label for="Admin-Keywords-keywords">搜索关键词</label>
    <input type="text" class="form-control input-sm" name="keywords" id="Admin-Keywords-keywords" <?php if(isset($search['keywords'])){echo 'value="'.$search['keywords'].'"'; } else {echo 'placeholder="数据详情"'; } ?>>
  </div>
  <div class="form-group">
    <label for="Admin-Keywords-state">是否显示</label>
