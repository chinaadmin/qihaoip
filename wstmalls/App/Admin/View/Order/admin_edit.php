...
<!-- content -->
        ...
        <?php } ?>        
          <ol class="breadcrumb">
  			...
  			<li class="active">商品订单编辑</a></li>
		  </ol>
          <h4 class="sub-header">编辑商品订单-查看用户的商品订单</h4>
          <div class="container-fluid">
<form class="form-horizontal" id="form-edit" action="#" method="post" onsubmit="return toVaild('form-edit')">
  ...
  <div class="form-group">
    <label for="Admin-Order-amount" class="col-sm-2 col-md-1 col-lg-1  control-label">总计</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
    <input type="text" class="form-control" name="amount" id="Admin-Order-amount" <?php if(isset($data['amount'])){echo 'value="'.$data['amount'].'"'; } ?>  placeholder="总计">
    </div>
  </div>
  <div class="form-group">
