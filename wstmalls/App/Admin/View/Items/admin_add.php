...
<!-- content -->
        ...
        <?php } ?>
          <ol class="breadcrumb">
  			...
  			<li class="active">商品分类新增</li>
		  </ol>
          <h4 class="sub-header">新增商品分类-商品分类模块，包含所有商品类别和子分类。</h4>
          <div class="container-fluid">
...
<div class="form-group">
    <label class="col-sm-2 col-md-1 col-lg-1  control-label" for="Admin-Items-about">类别说明</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
