			...
			<div class="zldetail_cons_left" id="yqljs0">
				...
				<div class="col-xs-12 zldetail_floor2">
					...
					<div class="zldetail_futu sbdetail_img">
						<a href="#" title="#"><img
							src="<?php echo $list['trade']['result']['items'][0]['fid']?U('Trade/GnTrade/tmimg',array('id'=>$list['trade']['result']['items'][0]['ftmid'],'class'=>$list['trade']['result']['items'][0]['fclass'])):$list['trade']['img'][0]; ?>" /></a>
					</div>
					<div class="zldetail_zhaiyao sbdetail_zhaiyao">
						<div class="zldetail_zhaiyaos sbdetail_zhaiyaos">
							...
							<p>【申请日期】：<?php echo $list['trade']['result']['items'][0]['fsqdate']?date('Y年m月d日',strtotime($list['trade']['result']['items'][0]['fsqdate'])):date('Y年m月d日',$list['trade']['sq_date'])?></p>
							<p>
					...
					<div class="zldetail_zhaiyaos">
						<table cellpadding="0" cellspacing="0" class="zldetail_law">
							...
							<?php elseif($value['type']):?>
								<tr>
									<td width="35%"><?php echo $value['type']?></td>
									<td width="65%"><?php echo $value['time']?></td>
								</tr>
							<?php endif?>
							<?php endforeach;?>
							</tbody>
