...
<div class="hytit">
您当前的位置：<a href="{:U('Buyer/order_list')}">买家中心</a> > <a href="{:U('Buyer/collect_shop')}">我收藏的店铺</a>
</div>
<div class="hgrzy">
<div class="col-xs-12 zhlist" id="dhconlist0">
<!-- <div class="col-xs-12">
<div class="zlyjjyst1 shop_padding">
  <form action="{:U('Buyer/collect_shop')}"  method="get">
      <div class="formdivs">
        <input type="text" name="search" class="pasearchs" placeholder="店铺名称" value="{$Think.get.search}"/>
...
<table cellpadding="0" cellspacing="0" class="tablesth_shop" id="fbtable1" rel="1">
	...
	<volist name="data['shop']" id="vo">
		<tr>
			...
			<td width="29%"><a style="line-height:60px;padding-left:10px;" href="__APP__/shop/shop_list/shop/{$vo['sid']}HTMLSUFFIX"><img src="{$vo['logo']}"/>{$vo['name']|msubstr=0,50}</a></td>
