...
<!-- content -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>文件名</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['filename']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>开始时间</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['starttime']; ?></p></div>
          </div>
          <div class="container-fluid">
          ...
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>条目数量</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['nums']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>成功记录</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['success']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>失败记录</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['failed']; ?></p></div>
          </div>
          <div class="container-fluid">
