...
<!-- content -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>买家支付账号</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['buyer']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>卖家支付id</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['buyid']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>创建时间</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['addtime']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>支付日期</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['date']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>支付时间</strong></div>
          ...
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['orders']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>支付金额</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['money']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>支付流水号</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['payid']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>支付类型</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['type']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>支付状态</strong></div>
