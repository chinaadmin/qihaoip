      ...
      <div class="col-xs-12 ">
          ...
          <div class="col-xs-12 zlsellist_guowai zls1 noborder_guowai" id="selects">
			...
			<?php if(!empty($search)):?>
				<?php foreach($search as $key =>$value):?>
					<?php if($key=='groupid'):?>
							...
							?>
              <li><a href="<?php create_url('shop',$where)?>" class="selon"><?php echo $groupid[$search['groupid']]?><span id="zls1" class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></li>
           <?php elseif($key=='groupid2'):?>
           			<?php 
						...
						unset($where['groupid3']);
					?>
              <li><a href="<?php create_url('shop',$where)?>" class="selon"><?php echo $groupid2[$search['groupid2']]?><span id="zls1" class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></li>
           <?php elseif($key=='groupid3'):?>
           			<?php 
						$where = $search;
						unset($where['groupid3']);
					?>
              <li><a href="<?php create_url('shop',$where)?>" class="selon"><?php echo $groupid3[$search['groupid3']]?><span id="zls1" class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></li>
			...
			<?php 
				...
				unset($where['tmtype']);
			?>
			 <li><a href="<?php create_url('shop',$where)?>" class="selon"><?php $type = C('ITEM_REG_TYPE'); echo $type[$search['tmtype']];?><span id="zls1" class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></li>
            <?php elseif($key=='price'):?>
			<?php 
				$where = $search;
				unset($where['price']);
			?>
			 <li><a href="<?php create_url('shop',$where)?>" class="selon"><?php  echo $data['price'][$search['price']];?><span id="zls1" class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></li>
            <?php elseif($key=='shop'):?>
			<?php 
				$shop = array();
			...
			<?php 
				...
				unset($where['shop']);
			?>
			 <li><a href="<?php create_url('shop',$where)?>" class="selon"><?php  echo $shop[$search['shop']];?><span id="zls1" class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></li>
			<?php endif;?>
			<?php endforeach;?>
			<?php endif;?>
            </ul>
          ...
          <div class="col-xs-12 zlsellist_guowai zls1 noborder_guowai" id="zlzls2">
            ...
            <?php foreach($data['groupid'] as $key=>$value):?>
           		...
           		unset($where['groupid3']);
           		 ?>
              <li><a href="<?php create_url('shop',$where)?>" <?php echo isset($search['groupid'])&&$search['groupid']==$value['id']?'class="selon"':''?>  id="se<?php echo $value['id']?>" title="<?php echo $value['name']?>" onClick="return check_num();"><?php echo $value['name']?></a></li>
			<?php endforeach;?>
            </ul>
          ...
          <div class="col-xs-12 zlsellist_guowai zls1 noborder_guowai" id="zlzls3">
            ...
            <?php foreach($data['groupid2'] as $key=>$value):?>
				...
				unset($where['groupid3']);
			?>
              <li><a href="<?php create_url('shop',$where)?>" <?php echo isset($search['groupid2'])&&$search['groupid2']==$value['id']?'class="selon"':''?> id="se<?php echo $value['id']?>" title="<?php echo $value['name']?>" onClick="return check_num();"><?php echo $value['name']?></a></li>
			<?php endforeach;?>
            </ul>
          ...
          <div class="col-xs-12 zlsellist_guowai zls1 noborder_guowai" id="zlzls4">
            ...
            <?php foreach($data['groupid3'] as $key=>$value):?>
				...
				unset($where['p']);
			?>
              <li><a href="<?php create_url('shop',$where)?>" <?php echo isset($search['groupid3'])&&$search['groupid3']==$value['id']?'class="selon"':''?> id="se<?php echo $value['id']?>" title="<?php echo $value['name']?>" onClick="return check_num();"><?php echo $value['name']?></a></li>
			<?php endforeach;?>
            </ul>
           ...
           <div class="col-xs-12 zlsellist_guowai noborder_guowai">
            ...
            <ul>
             <?php 
				...
				unset($where['p']);
			?>
				<li><a href="<?php create_url('shop',$where)?>" <?php echo !isset($search['tmtype'])?'class="selon"':''?>>全部</a></li>
			...
			<?php 
				...
				unset($where['p']);
			?>
			<li><a href="<?php create_url('shop',$where);?>" <?php echo isset($search['tmtype'])&&$search['tmtype']==$key?'class="selon"':''?> title="<?php echo $value;?>"><?php echo $value;?></a></li>
			<?php endforeach;?>
            </ul>
          </div>
          ...
          <div class="col-xs-12 zlsellist_guowai noborder_guowai">
            ...
            <ul>
              <?php 
				...
				unset($where['p']);
				?>
				<li><a href="<?php create_url('shop',$where)?>" <?php echo !isset($search['price'])?'class="selon"':''?>>全部</a></li>
			 ...
			 <?php 
				...
				unset($where['p']);
			 ?>
				<li><a href="<?php create_url('shop',$where)?>" <?php echo isset($search['price'])&&$search['price']==$key?'class="selon"':''?>><?php echo $value?></a></li>
			 <?php endforeach;?>
            </ul>
          </div>
          <div class="col-xs-12 zlsellist_guowai zls1 noborder_guowai" id="zlzls1">
            ...
            <ul>
			  ...
			  <?php 
				...
				unset($where['p']);
			  ?>
				<li><a href="<?php create_url('shop',$where)?>" <?php echo isset($search['shop'])&&$search['shop']==$value['id']?'class="selon"':''?> ><?php echo $value['name'];?></a></li>
			   <?php endforeach;?>
            </ul>
  ...
  <div class="thrfloor1">
    <div class="col-xs-12 zllist_sels">
      ...
      <?php 
		...
		unset($where['prices']);
	?>
		<li><a href="<?php create_url('shop',$where)?>" class="zllist_sels_ons">默认</a></li>
	<?php 
		$where_o = $search;
		if(!$where_o['prices']){
			$where_o['prices'] = 'desc';
		...
		if(!$where_s['views']){
				...
				$where_s['views'] ='desc';
							...
							?>
        <li><a href="<?php create_url('shop',$where_o)?>" >价格<span class="glyphicon glyphicon-arrow-<?php echo $search['prices']=='desc'?'down':'up'?>" aria-hidden="true"></span></a></li>
        <li><a href="<?php create_url('shop',$where_s)?>" >热门<span class="glyphicon glyphicon-arrow-<?php echo $search['views']=='desc'?'down':'up'?>" aria-hidden="true"></span></a></li>
      </ul>
