...
<!-- content -->
        ...
        <?php } ?>        
          <ol class="breadcrumb">
  			...
  			<li class="active">邮件发送模板编辑</a></li>
		  </ol>
          <h4 class="sub-header">编辑邮件发送模板-邮件发送模板</h4>
          <div class="container-fluid">
...
<?php get_select('configs', $data['configs']) ?>
    ...
    <label for="Admin-Emailstyle-data" class="col-sm-2 col-md-1 col-lg-1  control-label">模板内容</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
