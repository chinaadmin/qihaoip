...
<!-- content -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <ol class="breadcrumb">
  			...
  			<li><span>购物车管理</span></li>
  			<li class="active">购物车列表&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo U('admin_add'); ?>" target="_blank">新增购物车</a></li>
		  </ol>
          <div class="panel panel-default">
		  <div class="panel-heading">
<form class="form-inline" action="<?php echo U('admin_ShowList'); ?>" id="form-search" method="post">
  <div class="form-group">
    <label for="Admin-Cart-id">ID</label>
    <input type="text" class="form-control input-sm" name="id" id="Admin-Cart-id" <?php if(isset($search['id'])){echo 'value="'.$search['id'].'"'; } else {echo 'placeholder="数据id"'; } ?>>
  </div>
  <div class="form-group">
    <label for="Admin-Cart-item">商品id</label>
    <input type="text" class="form-control input-sm" name="item" id="Admin-Cart-item" <?php if(isset($search['item'])){echo 'value="'.$search['item'].'"'; } else {echo 'placeholder="商品id列表"'; } ?>>
  </div>
  <div class="form-group">
    <label for="Admin-Cart-edittime">最近修改时间</label>
    <input type="text" class="form-control input-sm" name="edittime" id="Admin-Cart-edittime" <?php if(isset($search['edittime'])){echo 'value="'.$search['edittime'].'"'; } else {echo 'placeholder="最近修改时间"'; } ?>>
  </div>
