	...
	<div class="hconright">
		<div class="hconrightcon">
			...
			<div class="hgrzy">
				...
				<div class="col-xs-5" style="padding-left: 20px;">商品信息</div><div class="col-xs-7"><div class="col-xs-2">买家</div><div class="col-xs-2">交易类型</div><div class="col-xs-2">应付金额</div><div class="col-xs-4">订单状态</div></div>
				<?php } else { ?>
				<div class="col-xs-5" style="padding-left: 20px;">商品信息</div><div class="col-xs-7"><div class="col-xs-2">买家</div><div class="col-xs-2">交易类型</div><div class="col-xs-2"></div><div class="col-xs-2"></div><div class="col-xs-4"></div></div>
				<?php } ?>
				</div>
				...
				<div class="col-xs-7">
				<div class="col-xs-2 posi_tion"><?php echo $data['buyer']['name']?$data['buyer']['name']:$data['buyer']['username']; ?>
				<div class="otherss othersst">
					<p>手机：<?php echo $data['buyer']['mobile']; ?></p>
					<p>电话：<?php echo $data['buyer']['tel']; ?></p>
					<p>邮箱：<?php echo $data['buyer']['email']; ?></p>
					<p>QQ：<?php echo $data['buyer']['qq']; ?></p>
				</div>
				</div>
