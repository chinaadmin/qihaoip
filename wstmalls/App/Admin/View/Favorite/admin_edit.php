...
<!-- content -->
        ...
        <?php } ?>        
          <ol class="breadcrumb">
  			...
  			<li><a href="<?php echo U('admin_ShowList'); ?>">收藏夹列表</a></li>
  			<li class="active">收藏夹编辑</a></li>
		  </ol>
          <h4 class="sub-header">编辑收藏夹-收藏商品等</h4>
          <div class="container-fluid">
<form class="form-horizontal" id="form-edit" action="#" method="post" onsubmit="return toVaild('form-edit')">
  <div class="form-group">
    <label for="Admin-Favorite-data" class="col-sm-2 col-md-1 col-lg-1  control-label">数据</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
    <input type="text" class="form-control" name="data" id="Admin-Favorite-data" <?php if(isset($data['data'])){echo 'value="'.$data['data'].'"'; } else {echo 'placeholder=""'; } ?>  placeholder="数据" value="">
    </div>
  </div>
