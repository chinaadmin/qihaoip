...
<!-- content -->
        ...
        <?php } ?>
          <ol class="breadcrumb">
  			...
  			<li class="active">用户评论新增</li>
		  </ol>
          <h4 class="sub-header">新增用户评论-用户在文章和商品下的评论</h4>
          <div class="container-fluid">
...
<div class="form-group">
    <label class="col-sm-2 col-md-1 col-lg-1  control-label" for="Admin-Comment-content">评论内容</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
