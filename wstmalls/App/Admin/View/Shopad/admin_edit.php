...
<!-- content -->
        ...
        <?php } ?>        
          <ol class="breadcrumb">
  			...
  			<li class="active">用户商铺广告编辑</a></li>
		  </ol>
          <h4 class="sub-header">编辑用户商铺广告-包含banner、商标和专利广告</h4>
          <div class="container-fluid">
...
<?php get_select('SHOP_AD_STATE', $data['state']) ?>
    ...
    <label for="Admin-Shopad-about" class="col-sm-2 col-md-1 col-lg-1  control-label">拒绝原因</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
