...
<!-- content -->
        ...
        <?php } ?>
          <ol class="breadcrumb">
  			...
  			<li class="active">站内广告新增</li>
		  </ol>
          <h4 class="sub-header">新增站内广告-包含banner、站内图片广告、滚动广告等</h4>
          <div class="container-fluid">
...
<div class="form-group">
    <label class="col-sm-2 col-md-1 col-lg-1  control-label" for="Admin-Ad-about">广告详情</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
