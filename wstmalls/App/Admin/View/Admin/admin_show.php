...
<!-- content -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <ol class="breadcrumb">
  			...
  			<li class="active">管理组查看数据</li>
		  </ol>
          <h4 class="sub-header">数据详情管理组-管理员角色配置</h4>
          <div class="container-fluid">
          <div class="container-fluid">
          ...
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>管理组名称</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['name']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>权限列表</strong></div>
