...
<!-- content -->
        ...
        <?php } ?>
          <ol class="breadcrumb">
  			...
  			<li class="active">用户账户新增</li>
		  </ol>
          <h4 class="sub-header">新增用户账户-所有用户资料</h4>
          <div class="container-fluid">
...
<div class="form-group">
    <label class="col-sm-2 col-md-1 col-lg-1  control-label" for="Admin-Member-about">个人简介</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
...
<div class="form-group">
    <label class="col-sm-2 col-md-1 col-lg-1  control-label" for="Admin-Member-address">地址</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
...
<?php get_select('USER_CHK', $data['bankcardchk']) ?>
    ...
    <label for="Admin-Member-password" class="col-sm-2 col-md-1 col-lg-1  control-label">用户密码</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
    <input type="text" class="form-control" name="password" id="Admin-Member-password" <?php if(isset($data['password'])){echo 'value="'.$data['password'].'"'; } else {echo 'placeholder=""'; } ?>  placeholder="用户密码" value="">
    </div>
  </div>
  <div class="form-group">
    <label for="Admin-Member-paypassword" class="col-sm-2 col-md-1 col-lg-1  control-label">支付密码</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
    <input type="text" class="form-control" name="paypassword" id="Admin-Member-paypassword" <?php if(isset($data['paypassword'])){echo 'value="'.$data['paypassword'].'"'; } else {echo 'placeholder=""'; } ?>  placeholder="支付密码" value="">
    </div>
  </div>
  <div class="form-group">
