...
<!-- content -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>文件地址</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['file']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>日期</strong></div>
          <div class="col-sm-10 col-md-11 col-lg-11"><p><?php echo $data['date']; ?></p></div>
          </div>
          <div class="container-fluid">
          <div class="col-sm-2 col-md-1 col-lg-1"><strong>时间</strong></div>
