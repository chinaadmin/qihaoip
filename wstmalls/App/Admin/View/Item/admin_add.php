...
<!-- content -->
        ...
        <?php } ?>
          ...
          <h4 class="sub-header">新增商品-包含所有商标和专利，以及以后可能出现的商品。</h4>
          <div class="container-fluid">
...
<?php get_select('ITEM_PATM', $data['tmpa']) ?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3 col-md-2 col-lg-2">
    <select class="form-control" id="Admin-Item-groupid3" name="groupid3">
    <option value ="0">未选择</option>
	</select>
	</div>
  </div>  <div class="form-group">
...
<div class="form-group">
    <label class="col-sm-2 col-md-1 col-lg-1  control-label" for="Admin-Item-keywords">关键词</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
...
<div class="form-group">
    <label class="col-sm-2 col-md-1 col-lg-1  control-label" for="Admin-Item-description">描述</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
...
<div class="form-group">
    <label class="col-sm-2 col-md-1 col-lg-1  control-label" for="Admin-Item-introduce">商品简介</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
...
<?php get_select('ITEM_TUIJIAN', $data['tuijian']) ?>
    ...
    <label class="col-sm-2 col-md-1 col-lg-1  control-label" for="ckeditor">商品内容详情</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
