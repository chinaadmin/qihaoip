...
<!-- content -->
        ...
        <?php } ?>        
          <ol class="breadcrumb">
  			...
  			<li class="active">文章分类编辑</a></li>
		  </ol>
          <h4 class="sub-header">编辑文章分类-包含新闻资讯帮助文档等分类</h4>
          <div class="container-fluid">
<form class="form-horizontal" id="form-edit" action="#" method="post" onsubmit="return toVaild('form-edit')">
  <div class="form-group">
    ...
    <select class="form-control" id="Admin-Articles-upid" name="upid">
    <option value ="0">未选择</option>
		<?php get_select('articles', $data['pcate']['id'],'level=1') ?>
	</select>
	</div>
  </div> 
  <div class="form-group">
    ...
    <option value ="0">未选择</option>
    	<?php get_select('articles', $data['scate']['id'],'level=2 and upid='.$data['pcate']['id']) ?>
	</select>
	</div>
  </div>
  <!-- <div class="form-group">
    ...
    <option value ="0">未选择</option>
    <?php get_select('articles', $data['id'],'level=3') ?>
	</select>
	</div>
  </div>  -->
<!--  <div class="form-group">
    ...
    <select class="form-control" id="Admin-Region-pid" name="proid" onchange="select1('Admin-Region-pid','Admin-Region-cid');">
    	<option value ="0">未选择</option>
		<?php get_select('region',$data['sheng']['id'],'level=1','','id','areaname') ?>
	</select>
	</div>
    ...
    <select class="form-control" id="Admin-Region-cid" name="cityid" onchange="select1('Admin-Region-cid','select_2');" >
		<option value ="0">未选择</option>
		<?php get_select('region',$data['shi']['id'],'level=2','','id','areaname') ?>
	</select>
	</div>
  </div> -->
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="Admin-Articles-keywords" class="col-sm-2 col-md-1 col-lg-1  control-label">关键词</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
  ...
  <div class="form-group">
    <label for="Admin-Articles-description" class="col-sm-2 col-md-1 col-lg-1  control-label">描述</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
