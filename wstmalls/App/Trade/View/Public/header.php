...
<html lang="zh-cn">
<head>
<title>会员中心-商标列表-商标管家-7号网</title>
...
<!--头部-->
<div class="htop">
<div class="htopleft"><a href="<?php echo U('Member/User/index')?>"  target="_blank">7号网会员中心</a> &nbsp;&nbsp;客服热线：400-889-7080</div>
<div class="htopright"><a href="<?php echo U('Member/User/index')?>"  target="_blank"><img src="<?php echo session('user.img')?session('user.img'):STATIC_V2.'images/member.jpg';?>"></a><a href="<?php echo U('Member/User/index')?>" target="_blank"><?php echo session('user.name')?session('user.name'):session('user.username');?></a>&nbsp;&nbsp;<a href="<?php echo U('/Index/User/logout'); ?>">【退出】</a> </div>
</div>
<!--logo与导航-->
<div class="hnavs newhnavs">
  <div class="col-xs-2 hlogo newhlogo"><a href="/" title="首页" target="_blank"><img src="<?php echo STATIC_V2;?>images/memlogo.png"/></a></div>
  <div class="col-xs-10 hnavlist newhnavlist">
    <ul>
      ...
      <li><a href="<?php echo U('Member/Buyer/index');?>" title="买家中心" <?php if(CONTROLLER_NAME == 'Buyer'){?>class="selnav"<?php }?>><img src="<?php echo CONTROLLER_NAME == 'Buyer'?STATIC_V2.'images/nav3s.png':STATIC_V2.'images/nav3.png'?>"/><br/>买家中心</a></li>
