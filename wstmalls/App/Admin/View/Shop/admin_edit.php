...
<!-- content -->
        ...
        <?php } ?>        
          <ol class="breadcrumb">
  			...
  			<li class="active">商铺编辑</a></li>
		  </ol>
          <h4 class="sub-header">编辑商铺-数据备注</h4>
          <div class="container-fluid">
<form class="form-horizontal" id="form-edit" action="#" method="post" onsubmit="return toVaild('form-edit')">
  ...
  <div class="form-group">
    <label for="Admin-Shop-description" class="col-sm-2 col-md-1 col-lg-1  control-label">SEO描述</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
  ...
  <div class="form-group">
    <label for="ckeditor" class="col-sm-2 col-md-1 col-lg-1  control-label">商城简介</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
  ...
  <div class="form-group">
    <label for="Admin-Shop-about" class="col-sm-2 col-md-1 col-lg-1  control-label">企业简介</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
  ...
  <div class="form-group">
    <label for="Admin-Shop-honor" class="col-sm-2 col-md-1 col-lg-1  control-label">荣誉资质</label>
    <div class="col-sm-10 col-md-11 col-lg-11">
