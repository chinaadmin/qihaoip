...
<form class="form-inline" action="<?php echo U('admin_ShowList'); ?>" id="form-search" method="post">
  <div class="form-group">
    <label for="Admin-Shourangzt-id">ID</label>
    <input type="text" class="form-control input-sm" name="id" id="Admin-Shourangzt-id" <?php if(isset($search['id'])){echo 'value="'.$search['id'].'"'; } else {echo 'placeholder="数据id"'; } ?>>
  </div>
  <div class="form-group">
    <label for="Admin-Shourangzt-memberid">归属id</label>
    <input type="text" class="form-control input-sm" name="memberid" id="Admin-Shourangzt-memberid" <?php if(isset($search['memberid'])){echo 'value="'.$search['memberid'].'"'; } else {echo 'placeholder="所有者id"'; } ?>>
  </div>
  <div class="form-group">
    <label for="Admin-Shourangzt-name">受让人</label>
    <input type="text" class="form-control input-sm" name="name" id="Admin-Shourangzt-name" <?php if(isset($search['name'])){echo 'value="'.$search['name'].'"'; } else {echo 'placeholder="名称"'; } ?>>
  </div>
