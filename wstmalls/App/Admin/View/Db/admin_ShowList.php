...
<!-- content -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <ol class="breadcrumb">
  			...
  			<li><span>数据库管理管理</span></li>
  			<li class="active">数据库管理列表&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo U('admin_add'); ?>" target="_blank">新增数据库管理</a></li>
		  </ol>
          <div class="panel panel-default">
		  <div class="panel-heading">
<form class="form-inline" action="<?php echo U('admin_ShowList'); ?>" id="form-search" method="post">
  <div class="form-group">
    <label for="Admin-Db-id">ID</label>
    <input type="text" class="form-control input-sm" name="id" id="Admin-Db-id" <?php if(isset($search['id'])){echo 'value="'.$search['id'].'"'; } else {echo 'placeholder="数据id"'; } ?>>
  </div>
  <div class="form-group">
    <label for="Admin-Db-data">数据</label>
    <input type="text" class="form-control input-sm" name="data" id="Admin-Db-data" <?php if(isset($search['data'])){echo 'value="'.$search['data'].'"'; } else {echo 'placeholder="数据详情"'; } ?>>
  </div>
