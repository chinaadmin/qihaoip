...
<div class="thrwid">
  ...
  <div class="thrwid moban2_nav">
    <div class="thrfloor1 moban2_navs">
      <ul>
	  <li><a class="moban2_ons">店铺首页</a></li>
	  <li><a>店铺简介</a></li>
	  <li><a>商标</a></li>
	  <li><a>专利</a></li>
	  <li><a>诚邀入驻</a></li>
  ...
  <div class="thrwid moban_banner">
	...
	<a href="<?php echo U('Index/shop/shop_list',array('shop'=>$data['shop_re']['id']))?>" target="_blank"><img src="<?php echo $data['shop_re']['logo']?$data['shop_re']['logo']:STATIC_V2.'images/logo_default.jpg'?>"/></a>
	<div class="col-xs-12 moban2_shopname">
	<?php echo $data['shop_re']['name']?$data['shop_re']['name']:'XXX'?>旗舰店
	</div>
	</div>
	
	<div class="col-xs-12 moban2_imgs"><a href="#" title="#"><img src="<?php echo $data['ad']['7']['img']?$data['ad']['7']['img']:STATIC_V2."images/red7.jpg" ?>"/></a>
	<button title="该图片190*186px" type="button" class="btn btn-primary zx_cks posts2" rel="7">编辑</button>
	</div>
	</div>
	<div class="col-xs-10">
      <div class="flexslider">
        <ul class="slides">
          <li style="background:url(<?php echo $data['ad']['1']['img']?$data['ad']['1']['img']:STATIC_V2."images/red1.jpg" ?>) 50% 0 no-repeat;"><a href="#" title="#" target="_blank"><img src="<?php echo STATIC_V2;?>images/blank.png" width="100%" height="430"></a></li>
        </ul>
      </div>
	  <button title="该图片1000*430px" type="button" class="btn btn-primary zx_cks posts2" rel="1">编辑</button>
	  </div>
    </div>
  </div>
  <!--banner-->
  ...
  <div class="thrfloor1">
    <div class="col-xs-12 thrsbscst">
      ...
      <div class="col-xs-12 shopsb_con">
        <div class="col-xs-3 shopsb_img moban_img">
          <div class="www51buycom_moban">
            <ul class="51buypic">
              <li><a href="#" target="_blank"><img src="<?php echo $data['ad']['2']['img']?$data['ad']['2']['img']:STATIC_V2."images/red2.jpg" ?>" /></a></li>
            </ul>
            <div class="num">
              <ul>
              </ul>
      ...
      <div class="col-xs-12 thrguangao"> <img src="<?php echo $data['ad']['3']['img']?$data['ad']['3']['img']:STATIC_V2."images/red3.jpg" ?>"/> 
  ...
  <div class="thrfloor1">
    <div class="col-xs-12 thrsbscst">
      ...
      <div class="col-xs-12 shopsb_con">
        <div class="col-xs-3 shopsb_img moban_img">
          <div class="www51buycom_moban1">
            <ul class="51buypic">
              <li><a href="#" target="_blank"><img src="<?php echo $data['ad']['4']['img']?$data['ad']['4']['img']:STATIC_V2."images/red4.jpg" ?>" /></a></li>
            </ul>
            <div class="num">
              <ul>
              </ul>
      ...
      <div class="col-xs-12 thrguangao"> <img src="<?php echo $data['ad']['5']['img']?$data['ad']['5']['img']:STATIC_V2."images/red5.jpg" ?>"/> 
